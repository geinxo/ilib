package ilib.util.fmt.json
{
	...
	public final class CvtJson
	{
		 ...
		 * @tiptext
		 */
		public static function toJson( o:Object ):String
		{
		 ...
		 * @tiptext
		 */
		public static function fromJson( s:String, strict:Boolean = true ):*
		{
